...
RUN curl https://sfc-repo.snowflakecomputing.com/snowsql/bootstrap/1.2/linux_x86_64/snowflake-snowsql-1.2.31-1.x86_64.rpm -o snowflake-snowsql-1.2.31-1.x86_64.rpm
...
RUN rpm -i snowflake-snowsql-1.2.31-1.x86_64.rpm
